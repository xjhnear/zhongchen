...
class Pinyin 
{
	static function convert($_String, $_Code='gb2312',$isInitial=false)
	{
		...
		foreach ($source as $str){
			$target .= ' '.self::_convert($str,1);
		}
		return $target;
		
	}
	static function _convert($_String, $_Code='gb2312',$isInitial=false)
	{
	...
	static function _Pinyin($_Num, $_Data,$isInitial)
	{
		if ($_Num>0 && $_Num<160 ){
			 return chr($_Num);
